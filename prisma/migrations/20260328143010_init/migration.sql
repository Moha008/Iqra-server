-- CreateEnum
CREATE TYPE "CourseType" AS ENUM ('LIVE', 'NON_LIVE');
...
-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('MULTIPLE_CHOICE', 'DIRECT');
...
-- CreateEnum
CREATE TYPE "AttachmentType" AS ENUM ('PDF', 'ZIP', 'DOCX', 'IMAGE', 'OTHER');
...
CREATE TABLE "Course" (
    ...
    "type" "CourseType" NOT NULL DEFAULT 'NON_LIVE',
    ...
    "Link" TEXT,
    "isActivelin" BOOLEAN NOT NULL DEFAULT false,
    "isActivelink" BOOLEAN NOT NULL DEFAULT false,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "ExamResult" (
    ...
    "faceValid" BOOLEAN NOT NULL DEFAULT true,
